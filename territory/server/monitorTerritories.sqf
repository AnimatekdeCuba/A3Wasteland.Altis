...
# @@Author: Nick 'Bewilderbeest' Ludlam <bewilder@recoil.org>, AgentRev Edited by: GMG_Monkey
...
_onCaptureFinished =
{
	...
	switch (_captureName) do {
		case ("TERRITORY_ConstructionZone") : {
			//i.e. you want this territory always to have 20 infantry
			//then it will be:
			//_infantryAlways = 20;
			//and so on
		};
		case ("TERRITORY_KavalaSquare") : {
			//this one is off
			//_terrEnabled=false;
		};
		case ("TERRITORY_KOREFACTORY") : {};
		case ("TERRITORY_MagosPowerPlant") : {};
		case ("TERRITORY_MagosStadium") : {};
		case ("TERRITORY_MilHillFactory") : {};
		case ("TERRITORY_MILHIllSouth") : {};
		...
		case ("TERRITORY_SofiaPowerPlant") : {};
		case ("TERRITORY_SofiaTown") : {};
		case ("TERRITORY_ZarosNorth") : {};
		case ("TERRITORY_ZarosSouth") : {};
		case ("TERRITORY_ABDERA") : {};
		case ("TERRITORY_GHOSTHOTEL") : {};
		case ("TERRITORY_KavalaCastle") : {};
		case ("TERRITORY_KavalaPeir") : {};
		case ("TERRITORY_LaborCamp") : {};
		case ("TERRITORY_MagosRadioStation") : {};
		case ("TERRITORY_MilHillBase") : {};
		case ("TERRITORY_MOLOS") : {};
		case ("TERRITORY_MOUTVillage") : {};
		case ("TERRITORY_OreoKastroCastle") : {};
		case ("TERRITORY_OreoKastroTown") : {};
		case ("TERRITORY_PANAGIA") : {};
		case ("TERRITORY_SofiaRadar") : {};
		case ("TERRITORY_THERISA") : {};
		case ("TERRITORY_ZarosRiga") : {};
	};
