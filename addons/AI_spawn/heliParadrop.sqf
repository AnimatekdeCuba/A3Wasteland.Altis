...
//Classnames:
_BLUmen = ["rhsusf_army_ocp_rifleman_10th","rhsusf_army_ocp_rifleman_1stcav","rhsusf_army_ocp_aa","rhsusf_army_ocp_maaws","rhsusf_army_ocp_medic","rhsusf_army_ocp_rifleman_m590","rhsusf_army_ocp_explosives","rhsusf_army_ocp_machinegunner","rhsusf_army_ocp_machinegunnera","rhsusf_army_ocp_teamleader","rhsusf_army_ocp_engineer","rhsusf_army_ocp_grenadier","rhsusf_army_ocp_rifleman_m16","rhsusf_army_ocp_sniper","rhsusf_army_ocp_sniper_m24sws","rhsusf_army_ocp_riflemanl","rhsusf_army_ocp_sniper_m107","rhsusf_army_ocp_fso","rhsusf_army_ocp_rifleman_m4","rhsusf_army_ocp_javelin_assistant","rhsusf_army_ocp_javelin"];
_OPFmen = ["rhs_vdv_des_aa","rhs_vdv_des_at","rhs_vdv_des_arifleman","rhs_vdv_des_efreitor","rhs_vdv_des_engineer","rhs_vdv_des_grenadier_rpg","rhs_vdv_des_strelok_rpg_assist","rhs_vdv_des_junior_sergeant","rhs_vdv_des_machinegunner","rhs_vdv_des_machinegunner_assistant","rhs_vdv_des_marksman_asval","rhs_vdv_des_marksman","rhs_vdv_des_medic","rhs_vdv_des_officer_armored","rhs_vdv_des_rifleman","rhs_vdv_des_rifleman_asval","rhs_vdv_des_grenadier","rhs_vdv_des_rifleman_lite","rhs_vdv_des_LAT","rhs_vdv_des_RShG2","rhs_vdv_des_sergeant","rhs_mvd_izlom_arifleman","rhs_mvd_izlom_marksman","rhs_mvd_izlom_machinegunner"];
_INDmen = ["rhsgref_nat_pmil_specialist_aa","rhsgref_nat_pmil_grenadier_rpg","rhsgref_nat_pmil_commander","rhsgref_nat_pmil_hunter","rhsgref_nat_pmil_machinegunner","rhsgref_nat_pmil_medic","rhsgref_nat_pmil_rifleman_aksu","rhsgref_nat_pmil_grenadier","rhsgref_nat_pmil_rifleman","rhsgref_nat_pmil_rifleman_m92","rhsgref_nat_pmil_saboteur"];
_BLUchopper = "RHS_UH60M_ESSS";
_OPFchopper = "RHS_Mi8AMT_vvs";
_INDchopper = "rhsgref_cdf_reg_Mi8amt";
