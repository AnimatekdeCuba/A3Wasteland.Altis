class VCOM
{
	...
	class Init
	{
		class VcomInit
		{
			file = "addons\Vcom\VcomInit.sqf";
			postInit = 1;
		};
		class VcomInitClient
		{
			file = "addons\Vcom\VcomInitClient.sqf";
			postInit = 1;
		};
		class CBA_Settings
		{
			file = "addons\Vcom\Functions\VCM_CBASettings.sqf";
		};
	};
...
class RYD
{
	...
	class FFE_Functions
	{
		file = "addons\Vcom\Functions\FFE_Functions";
		class AngTowards {};
		class ArtyMission {};
		class ArtyPrep {};
		class AutoConfig {};
	...
	class FFE_Shellview
	{
		file = "addons\Vcom\Functions\FFE_Shellview";
		class Shellview {};
	};
};