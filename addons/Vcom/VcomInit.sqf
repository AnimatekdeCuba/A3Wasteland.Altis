...
//Parameters
[] call compile preprocessFileLineNumbers "addons\Vcom\Functions\VCOMAI_DefaultSettings.sqf"; //Load default settings
...
[] spawn
{
	...
	if (VCM_FFEARTILLERY) then {nul = [] execVM "addons\Vcom\RYD_FFE\FFE.sqf";VCM_ARTYENABLE = false;};
