...
_code =
{
	private ["_bluforColor", "_opforColor", "_indieColor", "_civColor", "_defColor", "_allPlayers", "_i", "_scoreOrdering", 
			"_bountyLabel", "_players", "_playerCount", "_playerIndex", "_iStart", "_id", "_index", "_entry", "_player",
			"_isPlayer", "_bgColor", "_entryBG", "_entryTColor", "_textColor", "_textHexColor", "_entryRank", "_bounty",
			"_entryName", "_entryPKills", "_entryAIKills", "_entryDeaths", "_entryRevives", "_entryCaptures", "_entryAllKills",
			"_entryAllDeaths", "_entryKillDeath", "_teams", "_grp", "_side", "_teamCount", "_playerTeam", "_playerTeamIndex",
			"_team", "_isPlayerTeam", "_isGroup", "_teamName", "_entryTerritories"];
	...
	if (!isNull _display) then
	{
		...
		_scoreOrdering = { ((([_x, "playerKills"] call fn_getScore) - ([_x, "teamKills"] call fn_getScore)) * 100) + ([_x, "aiKills"] call fn_getScore) + ((_x getVariable ["bounty", 0]) * 10) };
