...
_foodtext ctrlSettext format["%1", round (player getVariable ["acex_field_rations_hunger", 0])];
_watertext ctrlSetText format["%1", round (player getVariable ["acex_field_rations_thirst", 0])];
