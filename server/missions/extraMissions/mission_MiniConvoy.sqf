...
_setupObjects =
{
	...
	{
		["rhsgref_ins_g_uaz_dshkm_chdkz", "rhsgref_ins_g_ural", "rhsgref_ins_g_uaz_dshkm_chdkz"]
	}
	else
	{
		[
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			case (_type isKindOf "rhsgref_ins_g_uaz_dshkm_chdkz"):
			{
				_soldier = [_aiGroup, _position] call createRandomSoldier;
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> transportando dos cajas de armas está siendo escoltado. Detén el convoy!", _vehicleName, extraMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "El convoy ha sido detenido, recoge las cajas y los vehículos.";
};
