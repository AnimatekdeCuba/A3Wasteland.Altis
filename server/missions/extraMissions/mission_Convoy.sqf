...
_setupObjects =
{
	...
	_convoyVeh =
	[
		["rhsusf_M1232_MC_M2_usmc_wd", "rhsusf_M1083A1P2_WD_fmtv_usarmy", "rhsusf_M1232_MC_M2_usmc_wd"],
		["rhsgref_BRDM2_vmf", "rhs_gaz66_vmf", "rhsgref_BRDM2_vmf"],
		["rhsgref_un_m1117", "rhsgref_un_ural", "rhsgref_un_m1117"]
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> transportando dos cajas de armas está siendo escoltado por vehículos armados. Deténlos!", _vehicleName, extraMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "El convoy ha sido detenido, puedes tomar las cajas de armas y los vehículos.";
};
