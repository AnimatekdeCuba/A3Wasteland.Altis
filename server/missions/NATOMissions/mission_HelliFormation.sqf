...
_setupObjects =
{
	...
	_veh1types = selectrandom ["RHS_AH64D_wd","RHS_AH1Z"];
	_veh2types = selectrandom ["RHS_UH1Y","rhs_uh1h_hidf_gunship"];
	_veh3types = selectrandom ["RHS_CH_47F_10","RHS_UH60M_d","rhsusf_CH53E_USMC_D"];
