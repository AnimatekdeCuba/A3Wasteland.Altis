...
_setupObjects =
{
	...
	_obj1 = createVehicle ["rhs_KORD_high_MSV", _bargate modelToWorld [6.5,-2,-4.1], [], 0, "NONE"];
	...
	_obj2 = createVehicle ["rhs_KORD_high_MSV", _bargate modelToWorld [-8,-2,-4.1], [], 0, "NONE"];
