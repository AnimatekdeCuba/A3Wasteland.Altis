...
//	@file Author: JoSchaap, ACSATtRev, LouD, GMG_Monkey
...
_setupObjects =
{
	...
	_veh1types = selectrandom ["rhs_mi28n_vvsc","RHS_Mi24V_vvsc"];
	_veh2types = selectrandom ["rhs_mi28n_vvsc","RHS_Mi24V_vvsc"];
