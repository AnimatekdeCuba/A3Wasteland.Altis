...
_setupObjects =
{
	...
	_missionHintText = "We are going to need a Bigger Boat.<br/>El enemigo está intentando recuperar armas y suministros sumergidos, mátalos y reclama su cargamento.";
};
...
_drop_item =
{
	...
	_successHintMessage = "El cargamento sumergido ha sido recuperado, bien hecho.";
};
