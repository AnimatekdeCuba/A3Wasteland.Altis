...
_setupObjects =
{
	...
	_missionHintText = "Suministros sumergidos han sido vistos en el océano cerca de la marca, y están muy bien custodiados. Se recomienda equipamiento de buceo y armas subacuáticas.";
};
...
_successExec =
{
	...
	_successHintMessage = "Suministros sumergidos han sido recolectados, bien hecho.";
};
