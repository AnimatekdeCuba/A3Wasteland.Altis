...
_setupObjects =
{
	...
	{
		(_vehChoices select 0) set [1, "RHS_AH64D"];
		(_vehChoices select 1) set [1, "RHS_Ka52_vvs"];
	...
	_createVehicle =
	{
 	...
 	_soldier triggerDynamicSimulation true;
		...
		switch (true) do
		{
			case (_type isKindOf "rhsusf_mkvsoc"):
			{
				...
				_soldier = [_aiGroup, _position] call createRandomSoldierC;
				_soldier moveInTurret [_vehicle, [2]]; // rear gunner
				_soldier = [_aiGroup, _position] call createRandomSoldierC;
				_soldier moveInTurret [_vehicle, [3]]; // rear gunner
				_soldier = [_aiGroup, _position] call createRandomSoldierC;
				_soldier moveInTurret [_vehicle, [4]]; // rear gunner
				_soldier = [_aiGroup, _position] call createRandomSoldierC;
				_soldier moveInTurret [_vehicle, [5]]; // rear gunner
			};
			...
			case (_type isKindOf "RHS_AH64D" || _type isKindOf "RHS_Ka52_vvs" || _type isKindOf "RHS_Mi24V_vvsc"):
			{
	...
	_missionHintText = format ["Dos <t color='%3'>%1</t> están patrullando la costa, escoltados por un <t color='%3'>%2</t>.<br/>Intercéptelos y recupere su cargamento!", _vehicleName, _vehicleName2, aquaticMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "La patrulla ha sido detenida, puedes cobrar el cargamento. Búscalos cerca de los restos!";
};
