...
_setupObjects =
{
	...
	_missionHintText = format ["Un tesoro de <t color='%1'>$100,000</t> y armas nuevas están siendo recuperadas.<br/>Si quieres capturarlo necesitarás equipamiento de buceo y armas subacuáticas."];
};
...
_successExec =
{
	...
	_successHintMessage = "The treasure has been captured, bien hecho.";
};
