...
_setupVars =
{
	...
	[
		...
		[
			...
			[
				[ // NATO convoy
					["rhsusf_M1220_M2_usarmy_d", "rhsusf_M1220_MK19_usarmy_d"], // Veh 1
					["rhsusf_M1220_M2_usarmy_d", "rhsusf_M1220_MK19_usarmy_d"] // Veh 2
				],
				[ // CSAT convoy
					["rhs_tigr_sts_3camo_msv", "rhsgref_BRDM2_HQ_vmf"], // Veh 1
					["rhs_tigr_sts_3camo_msv", "rhsgref_BRDM2_HQ_vmf"] // Veh 2
				],
				[ // AAF convoy
					["rhsgref_un_m1117", "rhsgref_BRDM2_HQ"], // Veh 1
					["rhsgref_un_m1117", "rhsgref_BRDM2_HQ"] // Veh 2
				]
			]
		],
		// Medium
		[
			...
			[
				[ // NATO convoy
					...
					["rhsusf_m113d_usarmy_M240", "rhsusf_M1232_M2_usarmy_d", "rhsusf_M1237_MK19_usarmy_d"], // Veh 2
					["rhsusf_M1232_M2_usarmy_d", "rhsusf_M1232_MK19_usarmy_d"] // Veh 3
				],
				[ // CSAT convoy
					["rhsgref_BRDM2_ins", "rhsgref_BRDM2_ATGM_ins"], // Veh 1
					["O_APC_Wheeled_02_rcws_F", "rhs_btr80a_msv", "rhs_bmp3mera_msv"], // Veh 2
					["rhsgref_BRDM2_ins", "rhsgref_BRDM2_ATGM_ins"] // Veh 3
				],
				[ // AAF convoy
					["rhsgref_BRDM2", "rhsgref_cdf_btr60"], // Veh 1
					["rhsgref_nat_btr70", "rhsgref_nat_btr70"], // Veh 2
					["rhsgref_BRDM2", "rhsgref_cdf_btr60"] // Veh 3
				]
			]
		],
		// Hard
		[
			...
			[
				[ // NATO convoy
					["rhsusf_m113_usarmy", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F"], // Veh 1
					["B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"], // Veh 2
					["rhsusf_m113_usarmy", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F"] // Veh 3
				],
				[ // CSAT convoy
		...
		[
			...
			[
				[ // NATO convoy
					["rhsusf_m113_usarmy", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F", "B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"], // Veh 1
					["B_APC_Tracked_01_AA_F", "B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"], // Veh 2
					["rhsusf_m113_usarmy", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F", "B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"], // Veh 3
					["rhsusf_m113_usarmy", "B_APC_Tracked_01_rcws_F", "B_APC_Tracked_01_AA_F", "B_MBT_01_cannon_F", "B_MBT_01_TUSK_F"] // Veh 4
