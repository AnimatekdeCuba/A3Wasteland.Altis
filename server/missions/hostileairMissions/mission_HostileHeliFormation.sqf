...
_setupObjects =
{
	...
	if (missionDifficultyHard) then
	{
		...
		(_heliChoices select 1) set [0, "rhs_mi28n_vvs"];
		(_heliChoices select 2) set [0, "rhs_mi28n_vvsc"];
	};
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			...
			case (_type isKindOf "RHS_AH64D_wd" || _type isKindOf "rhs_mi28n_vvs" || _type isKindOf "rhs_mi28n_vvsc"):
			{
