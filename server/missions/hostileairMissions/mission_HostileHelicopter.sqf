...
_setupObjects =
{
	...
	{
		selectRandom ["RHS_AH1Z_wd", "rhs_mi28n_vvs"] ;
	}
	else
	{
	...
	_createVehicle =
	{
		...
		switch (true) do
		{
			...
			case (_type isKindOf "RHS_AH1Z_wd" || _type isKindOf "rhs_mi28n_vvs"):
			{
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> de combate está patrullando la isla. Derríbalo y recupera su cargamento!", _vehicleName, hostileairMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "El cielo está despejado, el helicóptero patrulla ha sido derribado! Hay cajas de armas cerca de los restos.";
};
