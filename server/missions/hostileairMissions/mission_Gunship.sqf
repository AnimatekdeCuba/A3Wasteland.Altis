...
_setupObjects =
{
	...
	_missionHintText = format ["Un <t color='%2'>%1</t> armado está patrullando la isla. Échalo abajo y mata a los tripulantes para quitarles su dinero y armas!", _vehicleName, hostileairMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "El cielo está despejado, el enemigo a sido derribado. El cargamento está cerca de los restos, ve y búscalo!.";
};
