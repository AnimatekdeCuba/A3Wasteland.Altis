...
_setupObjects =
{
	...
	_veh1types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2", "rhsgref_cdf_bmd1p", "rhsgref_cdf_t80bv_tv"];
	_veh2types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2", "rhsgref_cdf_bmd2", "rhsgref_cdf_t80bv_tv"];
	_veh3types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2", "rhsgref_cdf_bmp1p", "rhsgref_cdf_t80bv_tv"];
	_veh4types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2", "rhsgref_cdf_bmp2d", "rhsgref_cdf_t80bv_tv"];
	_veh5types = selectRandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2", "rhsgref_cdf_bmd2", "rhsgref_cdf_t72bb_tv","rhsgref_cdf_ural","rhsgref_cdf_ural_fuel","rhsgref_cdf_ural_repair","rhsgref_cdf_gaz66_ammo"];
	_veh6types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2", "rhsgref_cdf_bmd2", "rhsgref_cdf_t72bb_tv","rhsgref_cdf_ural","rhsgref_cdf_ural_fuel","rhsgref_cdf_ural_repair","rhsgref_cdf_gaz66_ammo"];
	_veh7types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2_ATGM", "rhsgref_cdf_bmd2", "rhsgref_cdf_t72bb_tv"];
	_veh8types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2_ATGM", "rhsgref_cdf_bmp2d", "rhsgref_cdf_t72bb_tv"];
	_veh9types = selectrandom ["rhsgref_cdf_reg_uaz_dshkm","rhsgref_cdf_reg_uaz_ags","rhsgref_cdf_reg_uaz_spg9", "rhsgref_BRDM2_ATGM", "rhsgref_cdf_bmp2d", "rhsgref_cdf_t72bb_tv"];
