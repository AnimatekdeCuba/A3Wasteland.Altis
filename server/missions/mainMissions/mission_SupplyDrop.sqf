...
_setupObjects =
{
	...
	_missionHintText = format ["Ha sido avistado un <t color='%2'>%1</t> patrullando la isla. Elimínalo, mata a los tripulantes y hazte con sus armas y dinero antes que tu enemigo!", _vehicleName, mainMissionColor];
